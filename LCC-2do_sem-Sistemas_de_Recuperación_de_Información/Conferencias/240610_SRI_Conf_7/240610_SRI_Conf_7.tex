...
\date{10 de junio de  2024} % Presentation date or conference/meeting name, the optional parameter can contain a shortened version to appear on the bottom of every slide, while the required parameter value is output to the title slide
...
\begin{document}
	...
	\begin{frame}
		...
		% Windowing: Es común realizar primero la ventana, lo que significa aplicar una función de ventana a las muestras de cada cuadro.
	...
	\begin{frame}
		...
		% Tienen su origen en el procesamiento del habla, pero se ha descubierto que son adecuados para modelar el timbre de la voz.  \\[3mm]
